...
/*161*/	{"[M] Comisaría Número 53",			"Mediana, con vestuario, oficinas y celdas (Rawnker).",				1193.4746, 2799.4192, 816.8392, 270.0000,	3,	(TAG_MAPPING | TAG_MEDIANO | TAG_CHICO | TAG_EDIFICIO | TAG_HQ | TAG_POLICIA | TAG_SERVICIOS)},
...
/*227*/ {"[M] Hospital Central",			"Recepción del hospital central, amplia y moderna. (Rawnker)",		-2314.7451, -2297.9729, 801.0859, 179.6287,	1,	(TAG_MAPPING | TAG_HOSPITAL | TAG_SERVICIOS | TAG_GRANDE | TAG_EDIFICIO)},
...
/*254*/ {"[M] Interior Escuadrón GNA Base","Mediano, oficinas, con vestuarios, celdas. (Rawnker)",				1603.9404, 2196.4805, 1201.0859, 0.0, 	3,	(TAG_MAPPING | TAG_MEDIANO | TAG_EDIFICIO | TAG_POLICIA | TAG_OFICINAS) },
/*255*/ {"[M] Hospital Central",			"Sala de urgencias con quirofano y morgue (Rawnker)",				-2771.4446,-1712.4391,971.0859,359.7376,	1,	(TAG_MAPPING | TAG_HOSPITAL | TAG_SERVICIOS | TAG_GRANDE | TAG_EDIFICIO)},
/*256*/ {"[M] Hospital Central",			"Sala de terapia intensiva, internacion y laboratorio. (Rawnker)",	-1677.2197,-2402.8879,1201.0859,179.7743,	1,	(TAG_MAPPING | TAG_HOSPITAL | TAG_SERVICIOS | TAG_GRANDE | TAG_EDIFICIO)},
/*257*/ {"[M] Hospital Central",			"Consultorios, sector de imagenes. (Rawnker)",						-1573.7274,-1906.0955,1501.0859,0.1005,	1,	(TAG_MAPPING | TAG_HOSPITAL | TAG_SERVICIOS | TAG_GRANDE | TAG_EDIFICIO)},
/*258*/ {"[M] Hospital Central",			"Sector privado para los médicos. (Rawnker)",						-1540.3368,-1606.7816,1241.0859,0.0016,	1,	(TAG_MAPPING | TAG_HOSPITAL | TAG_SERVICIOS | TAG_GRANDE | TAG_EDIFICIO)},
/*259*/ {"[M] Garita Cajeros",				"Garita de los cajeros móviles del banco provincia (Rawnker)",		1112.6038, -1404.6091, 1401.0859, 270.000,	1,	(TAG_MAPPING | TAG_BANCO | TAG_SERVICIOS | TAG_MUYCHICO | TAG_EDIFICIO)},
/*260*/ {"[M] Interior 24/7 Chino",			"Mediano, descuidado, con carniceria (Santuxp10)",					638.03, 906.38, 951.08, 270.000,			1,	(TAG_MAPPING | TAG_247 | TAG_TIENDA | TAG_MEDIANO | TAG_NEGOCIO)},
/*261*/ {"[M] HQ Purple Dreams",			"Mediano, descuidado, con estudio de grabación.",					1730.3408,2632.1379,2401.0859,359.2997,			1,	(TAG_MAPPING | TAG_HQ | TAG_OFICINAS | TAG_MEDIANO | TAG_EDIFICIO)}
...
CMD:ainteriores(playerid, params[]) {
	...
	if(!sscanf(params, "i", mapid))
	{
		...
		if(TeleportPlayerTo(playerid, ServerInteriors[mapid][iX], ServerInteriors[mapid][iY], ServerInteriors[mapid][iZ], ServerInteriors[mapid][iAngle], ServerInteriors[mapid][iInt], GetPlayerVirtualWorld(playerid))) {
			SendFMessage(playerid, COLOR_INFO, "[INFO] "COLOR_EMB_GREY"Te tepeaste al mapa ID %i: %s.", mapid, ServerInteriors[mapid][iName]);
		} else {
			SendClientMessage(playerid, COLOR_ERROR, "[ERROR] "COLOR_EMB_GREY"No puedes moverte tan rápido de mapa en mapa. Debés esperar a que carguen los objetos.");
		}
	} else {
