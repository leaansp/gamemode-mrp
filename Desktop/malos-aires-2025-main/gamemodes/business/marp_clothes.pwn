...
static const maleUrbanSkins[] = {
	...
	268,269,270,271,273,289,291,292,293,297,20012,20013,20014,20015,20016
};
...
PMM_OnItemSelected:BizClothMenu(playerid, listitem, extraid)
{
	...
	{
		SendFMessage(playerid, COLOR_ERROR, "[ERROR] "COLOR_EMB_GREY"No tienes el dinero necesario ($%d).", price);
		return 1;
	}
